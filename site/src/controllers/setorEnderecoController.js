...
function entrar(req, res) {
    ...
    if (email == undefined) {
        ...
        setorEnderecoModel.entrar(email, senha)
            .then(
                function (resultado) {
...
function cadastrar(req, res) {
    ...
    if (numero == undefined) {
        ...
        // Passe os valores como parâmetro e vá para o arquivo setorEnderecoModel.js
        setorEnderecoModel.cadastrar(fkSetor,fkEndereco,numero,complemento)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
